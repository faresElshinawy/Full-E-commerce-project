...
<?php include_once "core/location_func.php" ?> 
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item" href="edit_city.php?id=<?= $row['city_id'] ?>">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="handlers/delete_city.php?id=<?= $row['city_id'] ?>">
