...
<!-- Page Heading -->
<h1 class="h3 mb-3 text-center text-gray-800">categories</h1>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $row['cat name'] ?></td>
                                <td>
                                    <img src="../uploaded/<?= $row['cat_image'] ?>" alt="" width='70' height='70'>
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item" href="edit_category.php?id=<?= $row['cat_id'] ?>">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="handlers/delete_category.php?id=<?= $row['cat_id'] ?>">
