...
<!-- Page Heading -->
<h1 class="h3 mb-3 text-center text-gray-800">brands</h1>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">brands tables</h6>
    </div>
    <div class="card-body">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <img src="../uploaded/<?= $row['brand_image'] ?>" alt="" width='70' height='70'>
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item" href="edit_brands.php?id=<?= $row['brand_id'] ?>">
                                                ...
                                                <path class = 'text-success' fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                                </svg>
                                                </a>
                                            </li>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="handlers/delete_brand.php?id=<?= $row['brand_id'] ?>">
