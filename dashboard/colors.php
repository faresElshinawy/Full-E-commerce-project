...
<!-- Page Heading -->
<h1 class="h3 mb-3 text-center text-gray-800">colors table</h1>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">colors table</h6>
    </div>
    <div class="card-body">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item" href="edit_color.php?id=<?= $row['color_id'] ?>">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="handlers/delete_color.php?id=<?= $row['color_id'] ?>">
